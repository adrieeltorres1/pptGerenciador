...
//                 <h2 className="text-[#1d1e46] text-center text-4xl py-2 font-bold">GERENCIADOR DE PTTs</h2>
...
//                             <button className="mt-44 px-4 py-2 w-[200px] bg-white text-[#1d1e46] rounded-lg hover:bg-[#79121f] hover:text-white transition-all duration-300"
//                             >
//                                 Buscar
//                             </button>
//                         </div>
...
//                                 className="mt-44 px-4 py-2 w-[200px] bg-white text-[#1d1e46] rounded-lg hover:bg-[#79121f] hover:text-white transition-all duration-300"
//                                 onClick={()=> 
