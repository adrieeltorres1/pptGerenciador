            ...
            <div className="flex flex-wrap gap-6 justify-center items-center p-6 bg-gray-100 min-h-screen">
                <div className="bg-[#1d1e46] w-[350px] h-[250px] rounded-lg text-white shadow-md">
                    ...
                    <div className="flex justify-center mt-28">
                        ...
                        onClick={() => {
                          window.open("https://drive.google.com/uc?export=download&id=19SXc4Pb0HRlCuDaDE0avNr1Xea9KyaEy", "_blank");
                        }}
                        >
                            Baixar PPT
                        </button>
                ...
                <div className="bg-[#1d1e46] w-[350px] h-[250px]  rounded-lg text-white shadow-md">
                    ...
                    <div className="flex justify-center mt-28" >
                        ...
                        onClick={() => {
                          window.open("https://drive.google.com/uc?export=download&id=1mIjC-3p96jgBjv-0OmaGMSPt4EX84aQu", "_blank");
                        }}
                        >
                            Baixar PPT
                        </button>
...
export default ProgramacaoComPython;